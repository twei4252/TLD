  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-zinc-100">
      ...
      <main className="pt-20 sm:pt-24">
        {/* Hero Section */}
        <section className="relative py-20 sm:py-32 bg-leather-950 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-leather-950/40 to-leather-950/80" />
          <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-display text-gold-400 mb-6 drop-shadow-lg">Our Story</h1>
            <p className="text-xl sm:text-2xl text-leather-200 font-serif max-w-3xl mx-auto">
              More than just a bar - we're part of the community
            </p>
          </div>
        </section>

        {/* Story Section */}
        <section className="py-20 sm:py-28 bg-leather-950">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="menu-card text-center mb-16 lg:mb-20">
              <p className="text-xl sm:text-2xl text-leather-200 font-serif mb-6 leading-relaxed">
              ...
              <p className="text-lg sm:text-xl text-leather-300 font-serif leading-relaxed">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-display text-gold-400 mb-12 lg:mb-16 text-center">Meet the Team</h2>
            
            {/* Team Member 1 - Left aligned */}
            <div className="menu-card mb-12 lg:mb-16 lg:flex items-center gap-8 lg:gap-12">
              <img
                src="https://images.pexels.com/photos/2102934/pexels-photo-2102934.jpeg?auto=compress&cs=tinysrgb&w=800"
                alt="Chase Phillips"
                className="w-full lg:w-1/3 h-64 sm:h-80 object-cover rounded-xl mb-6 lg:mb-0 shadow-xl"
              />
              <div>
                <h3 className="text-2xl sm:text-3xl font-display text-gold-400 mb-4">Chase Phillips</h3>
                <p className="text-leather-300 font-serif text-base sm:text-lg leading-relaxed">
            ...
            <div className="menu-card mb-12 lg:mb-16 lg:flex flex-row-reverse items-center gap-8 lg:gap-12">
              <img
              ...
              />
              <div>
                <h3 className="text-2xl sm:text-3xl font-display text-gold-400 mb-4">Steven Sen</h3>
                <p className="text-leather-300 font-serif text-base sm:text-lg leading-relaxed">
            ...
            <div className="menu-card mb-12 lg:mb-16 lg:flex items-center gap-8 lg:gap-12">
              ...
              />
              <div>
                <h3 className="text-2xl sm:text-3xl font-display text-gold-400 mb-4">Michael Alvarado</h3>
                <p className="text-leather-300 font-serif text-base sm:text-lg leading-relaxed">
            ...
            <div className="menu-card">
              <h3 className="text-3xl sm:text-4xl font-display text-gold-400 mb-6 text-center">Community Impact</h3>
              <div className="text-center mb-10">
                <p className="text-xl sm:text-2xl text-leather-200 font-serif mb-4 font-medium">1% of net profits to non-profits</p>
                <p className="text-leather-300 font-serif italic text-lg">Let us know your favorite non-profit we should support!</p>
              </div>
              <div className="grid sm:grid-cols-3 gap-6 text-center">
                <div className="bg-leather-900/50 p-4 rounded-lg">
                  <p className="text-leather-200 font-serif font-medium">Foothills Animal Shelter</p>
                </div>
                <div className="bg-leather-900/50 p-4 rounded-lg">
                  <p className="text-leather-200 font-serif font-medium">Denver Dream Center</p>
                </div>
                <div className="bg-leather-900/50 p-4 rounded-lg">
                  <p className="text-leather-200 font-serif font-medium">Food Bank of the Rockies</p>
                </div>
              </div>
            </div>

            <div className="menu-card mt-12 lg:mt-16 text-center">
              <p className="text-lg sm:text-xl text-leather-200 font-serif leading-relaxed">
